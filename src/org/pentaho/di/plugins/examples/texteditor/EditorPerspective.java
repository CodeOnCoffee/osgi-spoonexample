...
/**
 * For the sake of not having too many classes to look at this is both a SpoonPerspective and a FileListener.
 * This perspective uses XUL for the tabset as well as for the content of the tabs. You could reuse the tabs portion
 * and utilize plain SWT for the content if desired.
 *
 * User: nbaker
 * Date: 1/7/11
 */
  ...
  public boolean save(EngineMetaInterface meta, String fname, boolean isExport) {
    try{
      ...
      try {
        ...
        output.write(("<?xml version=\"1.0\"?><text>"+((EditorMeta) meta).getModel().getText()+"</text>").getBytes("UTF-8"));
