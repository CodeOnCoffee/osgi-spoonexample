...
/**
 * XUL-based content of the Example application. Shows the usage of bindings and the basics of how to construct an
 * MVC UI.
 *
 * User: nbaker
 * Date: 1/9/11
...
public class EditorUI {
  ...
  public EditorUI(EditorModel model){
    ...
    try {
      ...
      container = loader.loadXul("org/pentaho/di/plugins/examples/texteditor/res/notepad.xul", new PDIMessages(getClass())); //$NON-NLS-1$
